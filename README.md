...
1. Download the DMG and drag `Dev Cache Cleaner.app` into Applications.
...
```bash
xattr -cr "/Applications/Dev Cache Cleaner.app"
```
...
1. 下载 DMG 并将 `Dev Cache Cleaner.app` 拖入“应用程序”目录。
